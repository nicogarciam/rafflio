  ...
  <div className="space-y-8">
    <div className="text-center">
      <h1 className="text-3xl font-bold text-gray-900 mb-2">
        Bonos Contribución Disponibles
      </h1>
      <p className="text-gray-600 max-w-2xl mx-auto">
        Participa en nuestros sorteos y gana increíbles premios. 
        Selecciona tu bono de contribución favorito y elige tus números de la suerte.
      </p>
    </div>
    ...
    {raffles.filter(r => r.isActive).length === 0 && (
      <div className="text-center py-16">
        ...
        <p className="text-gray-600">
          Actualmente no tenemos bonos de contribución activos. ¡Vuelve pronto para nuevas oportunidades!
        </p>
      </div>
    )}
  </div>
